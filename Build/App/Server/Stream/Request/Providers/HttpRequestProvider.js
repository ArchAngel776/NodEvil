...
class HttpRequestProvider extends RequestProvider_1.default {
    constructor(core) {
        super();
        this.core = core;
    }
    getUrl() {
        const result = new Url_1.default(this.core.url).pure();
        return result;
    }
    getType() {
        switch (this.core.method) {
            ...
            default:
                throw new HttpMethodUnsupported_1.default(this.core.method);
        }
    }
    getHeaders() {
